...
\bottomrule
    ...
    \begin{tablenotes}[para,flushleft]
      \footnotesize
      \item Q38 and Q39 are semantically opposite questions. Q38 measures risky behavior (``have you ever copy-pasted without checking''), while Q39 measures diligent behavior (``do you meticulously verify every field'').
    \end{tablenotes}
  \end{threeparttable}
\end{table*}
