\begin{figure*}[t]
    \centering
    \includegraphics[width=2\columnwidth]{figure/Sec5_LLM/model_topic_heatmap.pdf}
    \caption{Hallucination rates (\%) for 13 LLMs across 40 computer science research domains. Darker colors indicate higher hallucination rates.}
